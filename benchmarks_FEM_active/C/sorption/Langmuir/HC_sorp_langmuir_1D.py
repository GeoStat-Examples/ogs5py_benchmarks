...
model = OGS(
    task_root='HC_sorp_langmuir_1D_root',
    task_id='HC_sorp_langmuir_1D',
    output_dir='out',
)
model.bc.add_block(
...
model.gli.read_file('HC_sorp_langmuir_1D.gli')
model.ic.add_block(
...
model.msh.read_file('HC_sorp_langmuir_1D.msh')
model.msp.add_block(
