...
model = OGS(
    task_root='conv_2D_cart_root',
    task_id='conv_2D_cart',
    output_dir='out',
)
model.gli.read_file('conv_2D_cart.gli')
model.ic.add_block(
...
model.msh.read_file('conv_2D_cart.msh')
model.msp.add_block(
...
model.st.add_block(
    ...
    PRIMARY_VARIABLE='TEMPERATURE2',
    GEO_TYPE=['POLYLINE', 'WALL'],
    DIS_TYPE=['TRANSFER_SURROUNDING', 10.0, 293.0],
)
model.tim.add_block(
