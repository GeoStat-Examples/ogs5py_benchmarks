...
model.bc.add_block(
    ...
    GEO_TYPE=['SURFACE', 'INFINIT'],
    DIS_TYPE=['CONSTANT', 0.0],
)
model.gli.read_file('LF_Theis_3D.gli')
model.ic.add_block(
...
model.msh.read_file('LF_Theis_3D.msh')
model.num.add_block(
    main_key='NUMERICS',
    PCS_TYPE='LIQUID_FLOW',
...
model.st.add_block(
    ...
    DIS_TYPE=['CONSTANT_NEUMANN', -0.00039329],
)
model.tim.add_block(
