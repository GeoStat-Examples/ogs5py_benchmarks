...
model = OGS(
    task_root='viscosity_yaws_root',
    task_id='viscosity_yaws',
    output_dir='out',
)
model.msh.read_file('viscosity_yaws.msh')
model.gli.read_file('viscosity_yaws.gli')
model.pcs.add_block(
    main_key='PROCESS',
...
model.rfd.read_file('viscosity_yaws.rfd')
model.bc.add_block(
