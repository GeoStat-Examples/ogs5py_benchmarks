...
model.asc.add(
    name='1pf_1pt_LIQUID_FLOW_ST_RHS',
    file_ext='.asc',
)
model.asc.read_file('1pf_1pt_LIQUID_FLOW_ST_RHS.asc')
model.asc.add(
    name='1pf_1pt_LIQUID_FLOW_BC_ST',
    file_ext='.asc',
)
model.asc.read_file('1pf_1pt_LIQUID_FLOW_BC_ST.asc')
model.write_input()
model.run_model()
