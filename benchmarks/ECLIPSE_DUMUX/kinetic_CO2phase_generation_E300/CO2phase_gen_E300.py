...
model.rfd.read_file('CO2phase_gen_E300.rfd')
model.tim.add_block(
...
asc_file = ASC(
    file_name='CO2phase_gen_E300_MULTI_PHASE_FLOW_ST_RHS',
    file_ext='.asc',
)
asc_file.read_file('CO2phase_gen_E300_MULTI_PHASE_FLOW_ST_RHS.asc')
