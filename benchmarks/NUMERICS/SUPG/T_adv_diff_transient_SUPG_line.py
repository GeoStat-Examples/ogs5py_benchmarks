...
model = OGS(
    task_root='T_adv_diff_transient_SUPG_line_root',
    task_id='T_adv_diff_transient_SUPG_line',
    output_dir='out',
)
model.bc.add_block(
...
model.gli.read_file('T_adv_diff_transient_SUPG_line.gli')
model.ic.add_block(
...
model.msh.read_file('T_adv_diff_transient_SUPG_line.msh')
model.msp.add_block(
