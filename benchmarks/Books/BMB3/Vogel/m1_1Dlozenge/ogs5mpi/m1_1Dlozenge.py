...
model = OGS(
    task_root='m1_1Dlozenge_root',
    task_id='m1_1Dlozenge',
    output_dir='out',
)
model.bc.add_block(
...
model.ddc.read_file('m1_1Dlozenge.ddc')
model.gli.read_file('m1_1Dlozenge.gli')
model.mmp.add_block(
    main_key='MEDIUM_PROPERTIES',
    GEOMETRY_DIMENSION=3,
)
model.msh.read_file('m1_1Dlozenge.msh')
model.msp.add_block(
...
model.rfd.read_file('m1_1Dlozenge.rfd')
model.st.add_block(
