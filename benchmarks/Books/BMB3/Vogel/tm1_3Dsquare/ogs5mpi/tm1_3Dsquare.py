...
model = OGS(
    task_root='tm1_3Dsquare_root',
    task_id='tm1_3Dsquare',
    output_dir='out',
)
model.msh.read_file('tm1_3Dsquare.msh')
model.gli.read_file('tm1_3Dsquare.gli')
model.ddc.read_file('tm1_3Dsquare.ddc')
model.pcs.add_block(
    main_key='PROCESS',
...
model.rfd.read_file('tm1_3Dsquare.rfd')
model.bc.add_block(
