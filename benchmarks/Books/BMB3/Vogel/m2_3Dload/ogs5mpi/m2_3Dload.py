...
model.ddc.read_file('m2_3Dload.ddc')
model.gli.read_file('m2_3Dload.gli')
model.mmp.add_block(
    main_key='MEDIUM_PROPERTIES',
    GEOMETRY_DIMENSION=3,
)
model.msh.read_file('m2_3Dload.msh')
model.msp.add_block(
...
model.rfd.read_file('m2_3Dload.rfd')
model.st.add_block(
