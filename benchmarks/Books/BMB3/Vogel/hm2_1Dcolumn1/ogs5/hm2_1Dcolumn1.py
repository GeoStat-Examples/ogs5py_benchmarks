...
model = OGS(
    task_root='hm2_1Dcolumn1_root',
    task_id='hm2_1Dcolumn1',
    output_dir='out',
)
model.bc.add_block(
...
model.gli.read_file('hm2_1Dcolumn1.gli')
model.ic.add_block(
...
model.msh.read_file('hm2_1Dcolumn1.msh')
model.msp.add_block(
...
model.rfd.read_file('hm2_1Dcolumn1.rfd')
model.st.add_block(
